...
#       priority = Priority.create! valid_attributes
#       get :show, params: {id: priority.to_param}, session: valid_session
...
#     it "assigns the requested priority as @priority" do
#       priority = Priority.create! valid_attributes
#       get :edit, params: {id: priority.to_param}, session: valid_session
#       expect(assigns(:priority)).to eq(priority)
#     end
#   end
...
#         expect {
#           post :create, params: {priority: valid_attributes}, session: valid_session
...
#         post :create, params: {priority: invalid_attributes}, session: valid_session
#         expect(assigns(:priority)).to be_a_new(Priority)
#       end
...
#         priority = Priority.create! valid_attributes
#         put :update, params: {id: priority.to_param, priority: new_attributes}, session: valid_session
#         priority.reload
...
#       it "assigns the requested priority as @priority" do
#         priority = Priority.create! valid_attributes
#         put :update, params: {id: priority.to_param, priority: valid_attributes}, session: valid_session
#         expect(assigns(:priority)).to eq(priority)
#       end
...
#         priority = Priority.create! valid_attributes
#         put :update, params: {id: priority.to_param, priority: invalid_attributes}, session: valid_session
#         expect(assigns(:priority)).to eq(priority)
#       end
...
#       priority = Priority.create! valid_attributes
#       expect {
#         delete :destroy, params: {id: priority.to_param}, session: valid_session
#       }.to change(Priority, :count).by(-1)
#     end
